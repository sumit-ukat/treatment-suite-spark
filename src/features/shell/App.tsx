  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          type="button"
          className="centre-switch flex items-center gap-1"
        >
      ...
      <div className="flex min-h-0 flex-1 overflow-hidden">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header className="topbar">
            {/* Hamburger — mobile only, opens off-canvas sidebar */}
            <button
              type="button"
              onClick={() => setMobileOpen((c) => !c)}
              className="mobile-toggle icon-btn md:hidden"
            ...
            {/* Breadcrumb: UKAT › Region › Centre switcher */}
            <div className="breadcrumb">
              ...
              <span className="region">{centre.region}</span>
              <ChevronRight size={10} className="crumb-chevron" aria-hidden="true" />
              <CentreSwitcher
                centres={centres}
                value={centreSlug}
            ...
            <div className="header-tools">
              ...
              <div className="header-clock hidden lg:flex">
                <LiveClock />
              </div>
